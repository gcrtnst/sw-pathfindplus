        ...
        },
        {
            ...
            expected_node_tbl = {
                ...
                [t.pf:_getNodeKey(-1000, -1000)] = {
                    ...
                    is_ocean = true,
                    edge_tbl = {
                        [t.pf:_getNodeKey(-2000, 0)] = {ocean_dist = 2000000^0.5, risky_dist = 0},
                    },
                    area_key = t.pf:_getNodeKey(-1/0, -1/0),
                    dirty = false,
                    visited = false,
            ...
            expected_node_key = t.pf:_getNodeKey(-2000, 0),
        },
        {
            input_world_x1 = 0,
            input_world_z1 = 0,
            ...
            expected_node_tbl = {
                ...
                [t.pf:_getNodeKey(-1000, -1000)] = {
                    ...
                    is_ocean = true,
                    edge_tbl = {
                        [t.pf:_getNodeKey(0, -2000)] = {ocean_dist = 2000000^0.5, risky_dist = 0},
                    },
                    area_key = t.pf:_getNodeKey(-1/0, -1/0),
                    dirty = false,
                    visited = false,
